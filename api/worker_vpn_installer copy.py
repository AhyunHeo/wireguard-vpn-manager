...
try {{
    ...
    # WireGuard 포트
    New-NetFirewallRule -DisplayName "WireGuard VPN Port In" -Direction Inbound -Protocol UDP -LocalPort 51820 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "WireGuard VPN Port Out" -Direction Outbound -Protocol UDP -LocalPort 51820 -Action Allow -ErrorAction SilentlyContinue
    ...
    # 워커노드 포트 허용
    New-NetFirewallRule -DisplayName "Worker API" -Direction Inbound -Protocol TCP -LocalPort 8001 -Action Allow -ErrorAction SilentlyContinue
    
    # Ray 분산학습 포트 허용 (중요!)
    # Ray Core 포트
    New-NetFirewallRule -DisplayName "Ray GCS/Redis" -Direction Inbound -Protocol TCP -LocalPort 6379 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray GCS/Redis Out" -Direction Outbound -Protocol TCP -LocalPort 6379 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray Client Server" -Direction Inbound -Protocol TCP -LocalPort 10001 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray Client Server Out" -Direction Outbound -Protocol TCP -LocalPort 10001 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray ObjectManager" -Direction Inbound -Protocol TCP -LocalPort 8076 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray ObjectManager Out" -Direction Outbound -Protocol TCP -LocalPort 8076 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray NodeManager" -Direction Inbound -Protocol TCP -LocalPort 8077 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray NodeManager Out" -Direction Outbound -Protocol TCP -LocalPort 8077 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray Dashboard" -Direction Inbound -Protocol TCP -LocalPort 8265 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray Metrics Export" -Direction Inbound -Protocol TCP -LocalPort 8090 -Action Allow -ErrorAction SilentlyContinue
    
    # Ray 추가 포트 (ray_port_config.py 참조)
    New-NetFirewallRule -DisplayName "Ray Runtime Env Agent" -Direction Inbound -Protocol TCP -LocalPort 52367 -Action Allow -ErrorAction SilentlyContinue
    
    # DDP/NCCL 포트 범위
    New-NetFirewallRule -DisplayName "DDP TCPStore" -Direction Inbound -Protocol TCP -LocalPort 29500-29509 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "DDP TCPStore Out" -Direction Outbound -Protocol TCP -LocalPort 29500-29509 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "NCCL Socket" -Direction Inbound -Protocol TCP -LocalPort 29510 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "NCCL Socket Out" -Direction Outbound -Protocol TCP -LocalPort 29510 -Action Allow -ErrorAction SilentlyContinue
    
    # Ray Worker 포트 범위
    New-NetFirewallRule -DisplayName "Ray Workers" -Direction Inbound -Protocol TCP -LocalPort 11000-11049 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray Workers Out" -Direction Outbound -Protocol TCP -LocalPort 11000-11049 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray Ephemeral" -Direction Inbound -Protocol TCP -LocalPort 30000-30049 -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "Ray Ephemeral Out" -Direction Outbound -Protocol TCP -LocalPort 30000-30049 -Action Allow -ErrorAction SilentlyContinue
    
    # VPN 서브넷 간 모든 TCP 통신 허용 (워커 노드 간 통신)
    New-NetFirewallRule -DisplayName "VPN Worker TCP All In" -Direction Inbound -Protocol TCP -RemoteAddress "10.100.1.0/24" -Action Allow -ErrorAction SilentlyContinue
    New-NetFirewallRule -DisplayName "VPN Worker TCP All Out" -Direction Outbound -Protocol TCP -RemoteAddress "10.100.1.0/24" -Action Allow -ErrorAction SilentlyContinue
